...
public class Programme_3_MarkSheet {
    public static void main(String[] args) {
       ...
       printMarkSheet(name, rollNum, mathMarks, scienceMarks, englishMarks, total, percentage, result, grade);
    ...
    public static void printMarkSheet(String name, int rollNum, int mathMarks, int scienceMarks, int englishMarks,
